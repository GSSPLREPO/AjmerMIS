<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="LabReportSMP.aspx.cs" Inherits="GEA_Ajmer.WebUI.LabReportSMP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Lab Report SMP</li>
        </ul>
    </div>
                ...
                <div id="divGrid" runat="server" class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>
                                    <asp:Label ID="lblHeading" runat="server" Text="Lab Report SMP"></asp:Label></h4>
                            </div>
...
<%--                                <asp:LinkButton ID="imgWordButton" runat="server" OnClick="imgbtnWord_OnClick" CssClass="btn btn-info quick-btn"><i class="fa fa-file-word-o"></i></asp:LinkButton>--%>
                    ...
                    <div class="panel-body" style="overflow: scroll;">
                        <asp:GridView runat="server" ID="gvLabReportSMP" CssClass="table table-hover table-striped" Width="100%" AutoGenerateColumns="False" GridLines="None"
                            OnPreRender="gvLabReportSMP_OnPreRender" OnRowCommand="gvLabReportSMP_OnRowCommand">
                            <Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script type="text/javascript">
        $(function () {
            $('#id_search').quicksearch('table#<%=gvLabReportSMP.ClientID%> tbody tr');
        });
    </script>
    <script type="text/javascript">
