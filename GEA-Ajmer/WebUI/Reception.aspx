<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reception.aspx.cs" MasterPageFile="../Masters/MainMaster.Master" Inherits="GEA_Ajmer.WebUI.Reception" %>
        ...
        <div id="divGrid" runat="server" class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-8">
                        <h4>
                            <asp:Label ID="lblHeading" runat="server" Text="Reception"></asp:Label></h4>
                    </div>
            ...
            <div class="panel-body">
                <asp:GridView runat="server" ID="gvReception" CssClass="table table-hover table-striped" AutoGenerateColumns="False" GridLines="None" OnPreRender="gvReception_OnPreRender" OnRowCommand="gvReception_OnRowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEdit" CommandName="Edit1" CommandArgument='<%# Eval("ReceptionId") %>' HeaderStyle-Width="20%" ItemStyle-Width="20%" ImageUrl="../images/Edit.png"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                       <%-- <asp:TemplateField HeaderText="Delete">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgDelete" CommandName="Delete1" CommandArgument='<%# Eval("ReceptionId") %>' HeaderStyle-Width="20%" ItemStyle-Width="20%" ImageUrl="../images/Delete.png" OnClientClick="javascript:return confirm('Do you really want to Delete this record?');"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                    </Columns>
                </asp:GridView>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="form-group has-error">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtRecName" CssClass="form-control" placeholder="Enter Reception Name" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtRecName" ValidationGroup="g1"
                                SetFocusOnError="True" ErrorMessage="Enter Reception Name." ForeColor="Red">*</asp:RequiredFieldValidator>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script type="text/javascript">
        $(function () {
            $('#id_search').quicksearch('table#<%=gvReception.ClientID%> tbody tr');
        });
    </script>
</asp:Content>
