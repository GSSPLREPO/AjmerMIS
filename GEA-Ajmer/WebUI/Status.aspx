<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="Status.aspx.cs" Inherits="GEA_Ajmer.WebUI.Status" %>
        ...
        <div id="divGrid" runat="server" class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-8">
                        <h4>
                            <asp:Label ID="lblHeading" runat="server" Text="Status"></asp:Label></h4>
                    </div>
            ...
            <div class="panel-body">
                <asp:GridView runat="server" ID="gvStatus" CssClass="table table-hover table-striped" AutoGenerateColumns="False" GridLines="None"
                    OnPreRender="gvStatus_OnPreRender" OnRowCommand="gvStatus_OnRowCommand">
                    <Columns>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="form-group has-error">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="Enter Status Name" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtName" ValidationGroup="g1"
                                SetFocusOnError="True" ErrorMessage="Enter Status Name." ForeColor="Red">*</asp:RequiredFieldValidator>
                        </div>
                    </div>
                </div>
                <%--<div class="row">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script type="text/javascript">
        $(function () {
            $('#id_search').quicksearch('table#<%=gvStatus.ClientID%> tbody tr');
        });
    </script>
</asp:Content>
