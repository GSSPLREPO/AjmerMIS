<%@ Page Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="LebReportSMP.aspx.cs" Inherits="GEA_Ajmer.WebUI.LebReportSMP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">SKIMMED MILK POWDER TESTING REPORT </li>
        </ul>
    </div>
    ...
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-1 right">
                        <asp:Button runat="server" ID="btnAddNew" Text="Add New" CssClass="btn btn-warning pull-right btn-addnew"  data-original-title="Select Project" data-placement="bottom" data-toggle="tooltip" ToolTip="Add New"></asp:Button>
                    </div>
                    <div class="col-md-2 right" id="divExport" runat="server">
                        <%-- <asp:LinkButton ID="LinkButton1" runat="server" OnClick="imbtnPDF_Click" CssClass="btn btn-danger quick-btn"><i class="fa fa-file-pdf-o"></i></asp:LinkButton>--%>
        ...
        <div class="panel panel-default" runat="server" id="divPanel">
            <div class="panel-heading">
                <h3 class="box-title">SKIMMED MILK POWDER TESTING REPORT</h3>
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group has-error">
                        <label class="col-md-2">Bag No & Weight</label>
                        <div class="col-md-4">
                            <div class="bootstrap-timepicker">
                                <div class="form-group">
                                    <div class="input-group">
                        ...
                        <label class="col-md-2">Appearance </label>
                        <div class="col-md-4">
                            <div class="bootstrap-timepicker">
                                <div class="form-group">
                                    <div class="input-group">
                ...
                <div class="row">
                    <div class="form-group has-error">
                        ...
                        <label class="col-md-2">Total Solids</label>
                        <div class="col-md-4">
                            <div class="bootstrap-timepicker">
                                <div class="form-group">
                                    <div class="input-group">
                ...
                <div class="row">
                    <div class="form-group has-error">
                        ...
                        <label class="col-md-2">Milk Fat(%)</label>
                        <div class="col-md-4">
                            <div class="bootstrap-timepicker">
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox runat="server" ID="txtAcidity" CssClass="form-control" placeholder="Enter Acidity" />
                    ...
                    <div class="form-group has-error">
                        ...
                        <div class="col-md-4">
                            <div class="bootstrap-timepicker">
                                ...
                                <a href="LabReportWMP.aspx">LabReportWMP.aspx</a>
                            </div>
                        </div>
                    </div>
                </div>
