<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="LabReportDW.aspx.cs" Inherits="GEA_Ajmer.WebUI.LabReportDW" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Lab Report DW</li>
        </ul>
    </div>
                ...
                <div id="divGrid" runat="server" class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>
                                    <asp:Label ID="lblHeading" runat="server" Text="Lab Report DW"></asp:Label></h4>
                            </div>
...
<%--                                <asp:LinkButton ID="imgWordButton" runat="server" OnClick="imgbtnWord_OnClick" CssClass="btn btn-info quick-btn"><i class="fa fa-file-word-o"></i></asp:LinkButton>--%>
                    ...
                    <div class="panel-body" style="overflow: scroll;">
                        <asp:GridView runat="server" ID="gvLabReportDW" CssClass="table table-striped" Width="100%" AutoGenerateColumns="False" GridLines="Both"
                            OnPreRender="gvLabReportDW_OnPreRender" OnRowCommand="gvLabReportDW_OnRowCommand">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Sugar" HeaderText="Sugar % by mass" ItemStyle-Width="10%" HeaderStyle-Width="10%" />
                ...
                <div class="panel-body" id="divPanel" runat="server">
                    ...
                    <div class="row" style="margin-bottom: 15px;">
                        <div class="form-group ">
                            ...
                            <div class="form-group">
                                <label class="col-md-2">Sugar % by mass</label>
                                <div class="col-md-4">
                                    <asp:TextBox runat="server" ID="txtSugar" CssClass="form-control" placeholder="Enter Sugar % by mass" onkeypress="return PreventDecimalPointValue(event)" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="txtSugar" ValidationGroup="g1"
                                        SetFocusOnError="True" ErrorMessage="Enter Sugar % by mass" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script type="text/javascript">
        $(function () {
            $('#id_search').quicksearch('table#<%=gvLabReportDW.ClientID%> tbody tr');
        });
    </script>
    <script type="text/javascript">
