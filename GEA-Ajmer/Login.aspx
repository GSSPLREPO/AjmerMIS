<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" EnableEventValidation="false" Inherits="GEA_Ajmer.Login" %>
...
<body style="background: url(images/Common.jpg) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
                    ...
                    <div class="panel panel-default" style="border-color: black; border-width: 2px">
                        <div class="panel-heading clearfix" style="height: 100px">
                            <div class="col-md-" style="float: left; padding-top: 8px;">
                                <img src="images/GEA_logo.png" style="height: 75px; width: 75px;" />
                            </div>
