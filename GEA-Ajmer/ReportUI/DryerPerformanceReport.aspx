<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="DryerPerformanceReport.aspx.cs" Inherits="GEA_Ajmer.ReportUI.DryerPerformanceReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script>
        $(document).ready(function () {
            $.ajax({
                type: "POST",
                url: "DryerPerformanceReport.aspx/BindGraph",
