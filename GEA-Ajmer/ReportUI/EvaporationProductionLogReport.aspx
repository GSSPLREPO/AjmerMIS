<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="EvaporationProductionLogReport.aspx.cs" Inherits="GEA_Ajmer.ReportUI.EvaporationProductionLogReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-file"></i> Evaporation Production Log Report</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10" style="font-size: 24px;">
                        <asp:Label runat="server" Text="Evaporation Production Log Report"/>
                    </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                        <asp:GridView runat="server" ID="gvEvaporationProductionLog" 
                            CssClass="table table-hover table-striped" OnPreRender="gvEvaporationProductionLog_PreRender" AutoGenerateColumns="false" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Quantity" HeaderText="Production Quantity" ItemStyle-Wrap="false" />
                            </Columns>
                        </asp:GridView>
