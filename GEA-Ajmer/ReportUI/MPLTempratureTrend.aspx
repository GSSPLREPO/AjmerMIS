<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="MPLTempratureTrend.aspx.cs" Inherits="GEA_Ajmer.ReportUI.MPLTempratureTrend" %>
        ...
        $(document).ready(function () {
            ...
            function ChartData() {
                ...
                $.ajax({
                    ...
                    data: '{strGraph:"First" ,Fromdate: "' + FromDate + '", Fromtime: "' + FromTime + '", Todate: "' + ToDate + '", Totime: "' + ToTime + '" }',
            ...
            function SuccessData(response) {
                ...
                for (var i in data2) {
                    ...
                    quarterPastPV.push(parseFloat(data2[i].MPL1_Past_TempPV));
                    quarterPastSP.push(parseFloat(data2[i].MPL1_Past_TempSP));
                    quarterChillPV.push(parseFloat(data2[i].MPL1_Chill_TempPV));
                    quarterChillSP.push(parseFloat(data2[i].MPL1_Chill_TempSP));
                    //quarterHotValveStatus.push((data2[i].MPL1_Hot_Valve_Status));
                    //quarterChillValveStatus.push((data2[i].MPL1_Cold_Valve_Status));

                    if (data2[i].MPL1_Hot_Valve_Status == true) {
                        quarterHotValveStatus.push(1);
                    }
                    else {
                        quarterHotValveStatus.push(0);
                    }
                    if (data2[i].MPL1_Cold_Valve_Status == true) {
                ...
                function BindChart_PastTemp(Date, quarterPastPV, quarterPastSP) {
                    ...
                    Highcharts.chart('containerForTempAV', {
                        ...
                        title: {
                            text: 'MPL-1 Temprature & Flow Diversion Log Trend (For Past-Temp (Deg C))'
                        },
                        xAxis: {
                ...
                function BindChart_ChillTemp(Date, quarterChillPV, quarterChillSP) {
                    ...
                    Highcharts.chart('containerForTempSP', {
                        ...
                        title: {
                            text: 'MPL-1 Temprature & Flow Diversion Log Trend (For Chill-Temp (Deg C))'
                        },
                        xAxis: {
                            //categories: ['01/01/2018 8:15', '01/01/2018 9:15', '01/01/2018 10:15', '01/01/2018 11:15', '01/01/2018 12:15', '02/01/2018 12:15', '02/01/2018 12:15', '02/01/2018 12:15', '02/01/2018 12:15']
                            categories: Date
                ...
                function BindValveStatus(Date, quarterHotValveStatus, quarterChillValveStatus) {
                    ...
                    Highcharts.chart('containerForHot_Valve', {
                        ...
                        title:
                            {
                            text:'Hot-Diversion Valve Status (On-Off)'
                            },
                        tooltip: {
                            valueDecimals: 0
                        },
                    ...
                    Highcharts.chart('containerForCold_Valve', {
                        ...
                        title:
                            {
                                text: 'Cold-Diversion Valve Status (On-Off)'
                            },
                        yAxis: [
                             {
                                 title: {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">MPL1 Temperature & Flow Diversion Trend</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10" style="font-size: 24px;">
                       MPL1 Temperature & Flow Diversion Trend
                    </div>
