...
{
    public partial class UtilityRawWaterStatusDayWise : System.Web.UI.Page
    {
        ...
        protected void btnGo_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                DateTime dtToDateTime = DateTime.ParseExact(txtToDate.Text + " " + txtToTime.Text, "dd/MM/yyyy HH:mm:ss",
                    System.Globalization.CultureInfo.InvariantCulture);
                var objResult = objLogBl.UtilityRawaterStatusReport_DayWise(dtFromDateTime, dtToDateTime);
        ...
        protected void imgbtnWord_OnClick(object sender, EventArgs e)
        {
            try
            {
                string filename = "DayWise_UtilityRawWaterStatusReport.docx";
        ...
        protected void imgbtnExcel_OnClick(object sender, EventArgs e)
        {
            try
            {
                Response.AddHeader("content-disposition", "attachment;filename=DayWise_UtilityRawWaterStatusReport.xls");
                Response.Charset = "";
                ...
                string strSubTitle = "DayWise Utility Raw Water Status REPORT";
        ...
        protected void imgbtnPDF_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "DayWise_UtilityRawWaterStatus_Report" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf";
                Response.AddHeader("content-disposition", "attachment;filename=" + filename);
