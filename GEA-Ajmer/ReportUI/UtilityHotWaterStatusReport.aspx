<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UtilityHotWaterStatusReport.aspx.cs" MasterPageFile="../Masters/MainMaster.Master" Inherits="GEA_Ajmer.ReportUI.UtilityHotWaterStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Utility Hot Water Status </li>
        </ul>
    </div>
    <div class="col-md-12">
                            ...
                            <HeaderTemplate>
                                <table cellspacing="1" rules="all" border="1">
                                    <tr style="border: inset">
                                        ...
                                        <th rowspan="1" colspan="4" style="width: 80px; text-align: center;">CIP Section
                                        </th>
