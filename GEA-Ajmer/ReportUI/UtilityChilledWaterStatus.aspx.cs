...
{
    public partial class UtilityChilledWaterStatus : System.Web.UI.Page
    {
        ...
        protected void btnGo_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                DateTime dtToDateTime = DateTime.ParseExact(txtToDate.Text + " " + txtToTime.Text, "dd/MM/yyyy HH:mm:ss",
                    System.Globalization.CultureInfo.InvariantCulture);
                var objResult = objLogBl.UtilityChilledWaterStatusReport(dtFromDateTime, dtToDateTime);
        ...
        protected void imgbtnWord_OnClick(object sender, EventArgs e)
        {
            try
            {
                string filename = "UtilityChilledWaterStatusReport.docx";
        ...
        protected void imgbtnExcel_OnClick(object sender, EventArgs e)
        {
            try
            {
                Response.AddHeader("content-disposition", "attachment;filename=UtilityChilledWaterStatusReport.xls");
                Response.Charset = "";
                ...
                //string strSubTitle = "Utility Chilled Water Status Report</br> as on " + Date;
                ...
                string strSubTitle = "Utility Chilled Water Status REPORT";
        ...
        protected void imgbtnPDF_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "UtilityChilledWaterStatus_Report" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf";
                Response.AddHeader("content-disposition", "attachment;filename=" + filename);
        ...
        protected void gvReport2_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                if (e.Row.RowType == DataControlRowType.Header)
                {
                    ...
                    //headerTableCell.RowSpan = 2;
                    headerTableCell.ColumnSpan = 4;
                    headerTableCell.Text = "HMST Section";
                    headerRow1.Controls.Add(headerTableCell);
                    ...
                    headerCell33.Text = "Pressure";
                    headerCell34.Text = "Flow";
                    headerCell35.Text = "Supply Temp";
                    headerCell36.Text = "Return Temp";
