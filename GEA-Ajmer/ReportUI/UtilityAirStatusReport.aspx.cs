...
{
    public partial class UtilityAirStatusReport : System.Web.UI.Page
    {
        private static ILog log = LogManager.GetLogger(typeof(UtilityAirStatusReport));
        ...
        protected void btnGo_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                DateTime dtToDateTime = DateTime.ParseExact(txtToDate.Text + " " + txtToTime.Text, "dd/MM/yyyy HH:mm:ss",
                    System.Globalization.CultureInfo.InvariantCulture);
                var objResult = objLogBl.UtilityAirStatusReport(dtFromDateTime, dtToDateTime);
        ...
        protected void imgbtnWord_OnClick(object sender, EventArgs e)
        {
            try
            {
                try
                {
                    string filename = "UtilityAirStatusReport.docx";
        ...
        protected void imgbtnExcel_OnClick(object sender, EventArgs e)
        {
            try
            {
                Response.AddHeader("content-disposition", "attachment;filename=UtilityAirStatusReport.xls");
                Response.Charset = "";
                ...
                //string strSubTitle = "Utility Air Status Report</br> as on " + Date;
        ...
        protected void gvReport2_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                if (e.Row.RowType == DataControlRowType.Header)
                {
                    ...
                    headerCell1.Text = "Process Section";
                    headerCell2.Text = "Packing Section";
                    headerCell3.Text = "CIP Section";
                    headerCell4.Text = "CURD Section";
                    headerCell5.Text = "m3/hr";
