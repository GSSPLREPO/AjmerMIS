<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TCIPLogReport.aspx.cs" MasterPageFile="../Masters/MainMaster.Master" Inherits="GEA_Ajmer.ReportUI.TCIPLogReport" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row" style="overflow: scroll;">
                    <asp:GridView ID="gvTCIPLogReport" runat="server" CssClass="table table-striped"  ShowHeader="false"
                        AutoGenerateColumns="true" GridLines="Both" HeaderStyle-Wrap="false" OnRowCreated="gvTCIPLogReport_RowCreated">
                    </asp:GridView>
                </div>
