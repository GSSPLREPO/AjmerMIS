<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="UtilitySoftWaterDayWise.aspx.cs" Inherits="GEA_Ajmer.ReportUI.UtilitySoftWaterDayWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Utility Soft Water Status Day Wise </li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10" style="font-size: 24px;">
                        Utility Soft Water Status Day Wise
                    </div>
