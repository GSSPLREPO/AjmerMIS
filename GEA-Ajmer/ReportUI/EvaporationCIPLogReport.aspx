<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="EvaporationCIPLogReport.aspx.cs" Inherits="GEA_Ajmer.ReportUI.EvaporationCIPLogReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-file"></i> Evaporation CIP Log Report</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10" style="font-size: 24px;">
                        <asp:Label runat="server" Text="Evaporation CIP Log Report"/>
                    </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                        <asp:GridView runat="server" ID="gvEvaporationCIPLog" 
                            CssClass="table table-hover table-striped" AutoGenerateColumns="true" 
                            GridLines="Both" HeaderStyle-Wrap="false" OnRowCreated="gvEvaporationCIPLog_RowCreated"
