...
{
    public partial class UtilitySoftWaterDayWise : System.Web.UI.Page
    {
        ...
        protected void imgbtnExcel_OnClick(object sender, EventArgs e)
        {
            try
            {
                Response.AddHeader("content-disposition", "attachment;filename=DayWise_UtilitySoftWaterStatusReport.xls");
                Response.Charset = "";
                ...
                string strSubTitle = "Day Wise Utility Soft Water Status REPORT";
        ...
        protected void imgbtnPDF_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "DayWise_UtilitySoftWaterStatus_Report" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf";
                Response.AddHeader("content-disposition", "attachment;filename=" + filename);
