<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/MainMaster.Master" AutoEventWireup="true" CodeBehind="WeighbridgeSummaryReport.aspx.cs" Inherits="GEA_Ajmer.ReportUI.WeighbridgeSummaryReport" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row" style="overflow: scroll;">
                    <asp:GridView runat="server" ID="gvWeighbridgeSummary" CssClass="table table-hover table-striped" ShowHeader="false"
                        AutoGenerateColumns="true" GridLines="Both" HeaderStyle-Wrap="false" OnRowCreated="gvWeighbridgeSummary_RowCreated">
