<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MilkWeighmentReport.aspx.cs" MasterPageFile="../Masters/MainMaster.Master" Inherits="GEA_Ajmer.ReportUI.MilkWeighmentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Milk Weighment </li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlReceptionLineNo" runat="server" CssClass="form-control input-sm inline-block"></asp:DropDownList>
                        </div>
                        <div class="col-md-3">
                ...
                <asp:GridView ID="gvReport1" runat="server" CssClass="table table-hover table-striped">
                </asp:GridView>
