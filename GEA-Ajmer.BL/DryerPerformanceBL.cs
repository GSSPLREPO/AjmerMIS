...
{
    public class DryerPerformanceBL
    {
        ...
        #region Insert Dryer Perfomance insert
        /// <summary>
        /// To Select All data from the Evap Log
        /// Created By : pavan, 07-07-2017
        /// Modified By :
        /// </summary>
        public ApplicationResult Insert_DryerPerformanceReport(int Id, string BreakdownHours, string IdleHours, string Remarks, DateTime ModifiedDate, int ModifiedId)
        {
            try
            {
                ...
                sSql = "usp_tbl_Dryer_Performance_Insert";
        ...
        #region Insert Dryer Perfomance Monthly insert
        /// <summary>
        /// To Select All data from the Evap Log
        /// Created By : pavan, 07-07-2017
        /// Modified By :
        /// </summary>
        public ApplicationResult Insert_DryerPerformanceMonthlyReport(int Id, string BreakdownHours, string IdleHours, string Remarks, DateTime ModifiedDate, int ModifiedId, string TotalHours, string Date, string OprationHours, string CIPHours, string percentegg)
        {
            try
            {
                ...
                sSql = "usp_tbl_Dryer_Performance_Monthly_Insert";
