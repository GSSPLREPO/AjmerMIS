...
namespace GEA_Ajmer.BL
{
    ...
    public class ProgramBl
    {
        ...
        #region Select All Cuircuit Details
        /// <summary>
        /// To Select All data from the Program table
        /// Created By : Chintan, 06-10-2015
        /// Modified By :
        /// </summary>
        public ApplicationResult Program_SelectAll()
        {
            try
            {
                sSql = "usp_tbl_Program_SelectAll";
        ...
        #region Select Program Details by Id
        /// <summary>
        /// Select all details of Cuircuit for selected Id from Program table
        /// Created By : Chintan, 06-10-2015
        /// Modified By :
        /// </summary>
        public ApplicationResult Program_Select(int intId)
        {
            try
            {
                ...
                strStoredProcName = "usp_tbl_Program_Select";
        ...
        #region Delete Program Details by Id
        /// <summary>
        /// To Delete details of Cuircuit for selected Id from Program table
        /// Created By : Chintan, 06-10-2015
        /// Modified By :
        /// </summary>
        public ApplicationResult Program_Delete(int intId, int intLastModifiedBy, string strLastModifiedDate)
        {
            try
            {
                ...
                strStoredProcName = "usp_tbl_Program_Delete";
        ...
        #region Insert Program Details
        /// <summary>
        /// To Insert details of Cuircuit in Program table
        /// Created By : Chintan, 06-10-2015
        /// Modified By :
        /// </summary>
        public ApplicationResult Program_Insert(ProgramBo objCuircuitBo)
        {
            try
            {
        ...
        #region Update Program Details
        /// <summary>
        /// To Update details of Cuircuit in Program table
        /// Created By : Chintan, 06-10-2015
        /// Modified By :
        /// </summary>
        public ApplicationResult Program_Update(ProgramBo objCuircuitBo)
        {
            try
            {
                pSqlParameter = new SqlParameter[5];
